...
def ResNet18_FRN(num_classes=10):
    return ResNet_FRN(BasicBlock, [2,2,2,2],num_classes=num_classes)

def ResNet34_FRN():
    return ResNet_FRN(BasicBlock, [3,4,6,3])

def ResNet50_FRN():
    return ResNet_FRN(Bottleneck, [3,4,6,3])

def ResNet101_FRN():
    return ResNet_FRN(Bottleneck, [3,4,23,3])

def ResNet152_FRN():
    return ResNet_FRN(Bottleneck, [3,8,36,3])
